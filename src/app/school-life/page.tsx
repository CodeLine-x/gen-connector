...
export default function SchoolLife() {
  ...
  return (
    <AuthWrapper>
      <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-amber-100 dark:from-gray-900 dark:to-gray-800 p-4 flex items-center justify-center">
        <div className="max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-auto w-full">
          <ConversationInterface
            riteOfPassage="school-life"
            sessionId={sessionId}
